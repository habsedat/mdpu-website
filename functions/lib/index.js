 ...
 */
exports.createMemberAccount = (0, https_1.onCall)(async (request) => {
    try {
        const { applicationId } = request.data;
        const { auth } = request;
        // Check if user is admin
        if (!auth || !auth.token.role || (auth.token.role !== 'admin' && auth.token.role !== 'superadmin')) {
            throw new https_1.HttpsError('permission-denied', 'Only admins can create member accounts');
        }
        ...
        if (applicationData.status !== 'approved') {
            throw new https_1.HttpsError('failed-precondition', 'Application must be approved first');
        }
        if (applicationData.accountCreated) {
            throw new https_1.HttpsError('already-exists', 'Account already created for this application');
        }
        ...
        throw new https_1.HttpsError('internal', `Failed to create account: ${error.message}`);
    }
});
exports.assignRole = (0, https_1.onCall)(async (request) => {
    try {
 ...
 */
exports.syncRolesOnSignIn = (0, identity_1.beforeUserSignedIn)(async (event) => {
    var _a, _b;
    if (!event.data)
        return;
    ...
    try {
        ...
        if (!roleDoc.exists) {
            ...
            if ((_a = event.data.customClaims) === null || _a === void 0 ? void 0 : _a.role) {
                await admin.auth().setCustomUserClaims(uid, { role: null });
            }
            return;
        }
        ...
        const currentRole = (_b = event.data.customClaims) === null || _b === void 0 ? void 0 : _b.role;
 ...
 * Runs hourly
 */
exports.cleanupExpiredRoles = (0, scheduler_1.onSchedule)({
 ...
 */
async function logAdminAction(action, actorUid, targetUid, inviteId, meta) {
    try {
 ...
 */
exports.createAdminInvite = (0, https_1.onCall)(async (request) => {
    try {
 ...
 */
exports.approveInvite = (0, https_1.onCall)(async (request) => {
    try {
 ...
 */
exports.claimAdminInvite = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        await logAdminAction('invite_claimed', auth.uid, auth.uid, inviteId, {
            role: result.role,
            expiresAt: ((_d = (_c = (_b = (_a = result.expiresAt) === null || _a === void 0 ? void 0 : _a.toDate) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.toISOString) === null || _d === void 0 ? void 0 : _d.call(_c)) || null,
        });
        ...
        return {
            ...
            role: result.role,
            expiresAt: ((_h = (_g = (_f = (_e = result.expiresAt) === null || _e === void 0 ? void 0 : _e.toDate) === null || _f === void 0 ? void 0 : _f.call(_e)) === null || _g === void 0 ? void 0 : _g.toISOString) === null || _h === void 0 ? void 0 : _h.call(_g)) || null,
        };
    }
    catch (error) {
 ...
 * Superadmin only
 */
exports.extendAdminRole = (0, https_1.onCall)(async (request) => {
    try {
